package com.dataart.subcontractorstool.apitests.tests.project.projectstaffidtests;
...
public class ProjectStaffIdGetTests {
     ...
     * WHEN I send a GET to api/Project/Staff/{StaffId} endpoint
     * THEN I should get Status Code of 200 and success message
     */
    @Test
    public void getProjectsByStaffIdTest() {
        ProjectStaffGet response = projectController.getProjectsByStaffId(staffId);
