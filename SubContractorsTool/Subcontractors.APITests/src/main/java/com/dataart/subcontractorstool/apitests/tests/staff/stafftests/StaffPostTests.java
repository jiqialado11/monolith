...
import com.dataart.subcontractorstool.apitests.responseentities.staff.StaffCreate;
...
public class StaffPostTests {
     ...
     * WHEN I send a POST to api/Staff endpoint
     * THEN I should get Status Code of 201 and success message
     */
    @Test
    public void createStaffTest() {
        StaffCreate createResponse = staffController.createStaff(StaffPayloads.createStaff(pmStaffId, subContractorId, StaffTestsConstants.FIRST_NAME, StaffTestsConstants.LAST_NAME, StaffTestsConstants.EMAIL, StaffTestsConstants.SKYPE, StaffTestsConstants.POSITION, StaffTestsConstants.START_DATE, StaffTestsConstants.END_DATE, StaffTestsConstants.QUALIFICATIONS, StaffTestsConstants.REAL_LOCATION, StaffTestsConstants.CELL_PHONE, StaffTestsConstants.IS_NDA_SIGNED, StaffTestsConstants.DEPARTMENT_NAME, StaffTestsConstants.DOMAIN_LOGIN));
        ...
        staffId = createResponse.getData();
        ...
        Assert.assertEquals(getResponse.getData().getSkype(), StaffTestsConstants.SKYPE);
