...
public class InvoicePostTests {
    ...
    public void createInvoiceTest() {
        ...
        Assert.assertTrue(createInvoiceResponse.getIsSuccess());
        Assert.assertEquals(createInvoiceResponse.getStatusCode(), CommonTestsConstants.STATUS_CODE_201);
        Assert.assertEquals(createInvoiceResponse.getMessage(), CommonTestsConstants.SUCCESS_MESSAGE);
        Assert.assertNotNull(createInvoiceResponse.getData());

        int invoiceId = createInvoiceResponse.getData();
        ...
        Assert.assertEquals(getInvoicesResponse.getData()[0].getAmount(), InvoiceTestsConstants.AMOUNT);
