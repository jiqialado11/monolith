...
public class SubContractorTaxesPostTests {
     ...
     * WHEN I send a POST to api/SubContractor/{SubcontractorId}/Tax endpoint
     * AND POST request is not allowed for api/SubContractor/{SubcontractorId}/Tax endpoint
     * THEN I should get Status Code of 405 and error message
     */
    @Test
    public void subContractorTaxesCreateTest() {
        subContractorController.createTaxes(subContractorId);
    }
}