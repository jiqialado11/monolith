...
public class SubContractorStaffDeleteTests {
    ...
    public void setupTest() throws IOException {
        ...
        subContractorController.assignStaffToSubContractor(SubContractorPayloads.assignStaffToSubContractor(subContractorIdForAssign, staffId));
    }

    /**
     * GIVEN As a Vendor manager
     * WHEN I send a DELETE to api/SubContractor/Staff endpoint
     * THEN I should get Status Code of 200 and success message
     */
    @Test
    public void unassignStaffToSubContractorTest() {
        SubContractorStaffDelete deleteResponse = subContractorController.unassignStaffToSubContractor(subContractorIdForAssign, staffId);
        ...
        StaffSubContractorIdGet getResponse = staffController.getStaffListBySubContractorID(subContractorIdForAssign);

        Assert.assertNull(getResponse.getData());
    }
}