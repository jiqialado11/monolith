...
import com.dataart.subcontractorstool.apitests.responseentities.agreement.AgreementAddendumRateUpdate;
...
public class AgreementAddendumRatePutTests {
     ...
     * WHEN I send a PUT to api/Agreement/Addendum/Rate endpoint
     * AND all values are valid
     * THEN I should get Status Code of 202 and success message
     */
    @Test
    public void updateRateTest() {
        AgreementAddendumRateUpdate updateResponse = agreementController.updateRate(AgreementPayloads.updateRate(rateId, staffId, AgreementAddendumRateTestsConstants.NAME_UPDATE, AgreementAddendumRateTestsConstants.RATE, RATE_UNIT_ID, AgreementAddendumRateTestsConstants.FROM_DATE, AgreementAddendumRateTestsConstants.TO_DATE, AgreementAddendumRateTestsConstants.DESCRIPTION));
        ...
        Assert.assertEquals(getResponse.getData().getTitle(), AgreementAddendumRateTestsConstants.NAME_UPDATE);
