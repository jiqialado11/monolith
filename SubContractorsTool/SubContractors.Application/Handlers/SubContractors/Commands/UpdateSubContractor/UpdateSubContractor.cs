...
{
    public class UpdateSubContractor : IRequest<Result<Unit>>, IInvalidateCacheRequest
    {
    ...
    public class UpdateSubContractorValidator : AbstractValidator<UpdateSubContractor>
    {
