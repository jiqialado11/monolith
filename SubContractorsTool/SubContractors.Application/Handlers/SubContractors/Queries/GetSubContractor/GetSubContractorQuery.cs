...
{
    public class GetSubContractorQuery : IRequest<Result<GetSubContractorDto>>
    {
        public int? Id { get; set; }
    }

    public class GetSubContractorQueryValidator : AbstractValidator<GetSubContractorQuery>
    {
        public GetSubContractorQueryValidator()
        {
            RuleFor(x => x.Id)
                .NotEmpty()
