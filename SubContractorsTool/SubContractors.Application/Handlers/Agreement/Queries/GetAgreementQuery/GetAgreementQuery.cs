...
{
    public class GetAgreementQuery : IRequest<Result<GetAgreementDto>>
    {
        public int? Id { get; set; }
    }

    public class GetAgreementQueryValidator : AbstractValidator<GetAgreementQuery>
    {
        public GetAgreementQueryValidator()
        {
            RuleFor(x => x.Id)
                .NotEmpty()
