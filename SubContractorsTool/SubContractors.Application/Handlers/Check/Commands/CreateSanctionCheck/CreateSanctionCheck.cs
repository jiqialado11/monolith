...
{
    public class CreateSanctionCheck : IRequest<Result<int>>
    {
    ...
    public class CreateSanctionCheckValidator : AbstractValidator<CreateSanctionCheck>
    {
        public CreateSanctionCheckValidator()
        {
