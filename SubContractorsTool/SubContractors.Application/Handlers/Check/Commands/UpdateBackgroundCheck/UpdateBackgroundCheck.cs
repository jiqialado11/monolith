...
{
    public class UpdateBackgroundCheck : IRequest<Result<Unit>>
    {
    ...
    public class UpdateBackgroundCheckValidator : AbstractValidator<UpdateBackgroundCheck>
    {
        public UpdateBackgroundCheckValidator()
        {
